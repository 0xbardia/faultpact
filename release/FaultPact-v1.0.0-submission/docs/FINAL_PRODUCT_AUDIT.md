...
- Submission archive: distributed beside the repository snapshot as `release/FaultPact-v1.0.0-submission.zip`.
- Submission SHA-256: recorded in the repository sidecar `.sha256` file; omitted from this archive snapshot to avoid a self-referential checksum.
